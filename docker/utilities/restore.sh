...
then
    ...
    then
        ...
        then
            ...
            docker exec -it $dockerMysqlContainer mysqladmin -h localhost -f -u root -proot drop sugar | grep -v "mysqladmin: \[Warning\]"
            docker exec -it $dockerMysqlContainer mysqladmin -h localhost -u root -proot create sugar | grep -v "mysqladmin: \[Warning\]"
            ...
            then
                cat $BACKUP_DIR/sugar.sql | docker exec -i $dockerMysqlContainer mysql -h localhost -u root -proot sugar
