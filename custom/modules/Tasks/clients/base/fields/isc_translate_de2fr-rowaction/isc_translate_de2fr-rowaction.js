 ...
 * Description   : Deutsch → Französisch Übersetzung + Kopier-Button
 * ----------------------------------------------------------------------------
 */
//custom/modules/Tasks/clients/base/fields/isc_translate_de2fr-rowaction/isc_translate_de2fr-rowaction.js
({
    extendsFrom: 'ButtonField',
    baseClass  : 'isc-translate-de2fr-btn',

    initialize: function (opts) {
        opts.def.events = _.extend({}, opts.def.events, {
            'click .isc-translate-de2fr-btn': 'translate'
        });
    ...
    translate: function () {
        ...
        if (!text.trim()) {
            app.alert.show('isc-no-desc', {
                level:'info',
                messages: app.lang.get('LBL_ISC_DEEPL_NO_DESC') || 'Keine Beschreibung.'
            });
            return;
        }
        ...
        app.alert.show('isc-tx', {
            level:'info',
            messages: app.lang.get('LBL_ISC_DEEPL_TX_DE2FR') || 'Übersetze …',
            autoClose:false
        });
    ...
    _handleSuccess: function (data) {
        ...
        /* Formatierung je nach aktueller Sugar-Sprache */
        ...
        app.api.call(
            ...
            },
            {
                ...
                success: _.bind(function (res) {
                    ...
                    /* 2a Busy-Alert schließen & OK-Alert zeigen */
