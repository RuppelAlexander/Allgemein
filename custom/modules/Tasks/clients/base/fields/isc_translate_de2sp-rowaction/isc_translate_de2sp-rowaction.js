 ...
 * Description   : Deutsch → Spanisch Übersetzung + Kopier-Button
 * ----------------------------------------------------------------------------
 */

//custom/modules/Tasks/clients/base/fields/isc_translate_de2sp-rowaction/isc_translate_de2sp-rowaction.js
({
    extendsFrom: 'ButtonField',
    baseClass  : 'isc-translate-de2sp-btn',

    initialize: function (opts) {
        opts.def.events = _.extend({}, opts.def.events, {
            'click .isc-translate-de2sp-btn': 'translate'
        });
    ...
    translate: function () {
        ...
        app.alert.show('isc-tx',{
            level:'info',
            messages: app.lang.get('LBL_ISC_DEEPL_TX_DE2ES'),
            autoClose:false
        });
