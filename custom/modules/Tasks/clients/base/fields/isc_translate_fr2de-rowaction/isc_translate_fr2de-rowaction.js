 ...
 * Description   : isc_translate_fr2de-rowaction.js
 * ----------------------------------------------------------------------------
 */
//custom/modules/Tasks/clients/base/fields/isc_translate_fr2de-rowaction/isc_translate_fr2de-rowaction.js
({
    extendsFrom: 'ButtonField',
    baseClass  : 'isc-translate-fr2de-btn',

    initialize: function (opts) {
        opts.def.events = _.extend({}, opts.def.events, {
            'click .isc-translate-fr2de-btn': 'translate'
        });
    ...
    translate: function () {
        ...
        app.alert.show('isc-tx',{
            level:'info',
            messages: app.lang.get('LBL_ISC_DEEPL_TX_FR2DE'),
            autoClose:false
        });
    ...
    _handleSuccess: function (data) {
        ...
        /* Kopier-Handler einmalig registrieren */
