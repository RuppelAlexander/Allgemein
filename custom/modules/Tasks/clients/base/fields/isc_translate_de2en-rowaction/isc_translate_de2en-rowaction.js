 ...
 * Description   : Deutsch → Englisch Übersetzung + Kopier-Button
 * ----------------------------------------------------------------------------
 */
//          custom/modules/Tasks/clients/base/fields/isc_translate_de2en-rowaction/isc_translate_de2en-rowaction.js
({
    extendsFrom: 'ButtonField',
    baseClass  : 'isc-translate-de2en-btn',

    initialize: function (opts) {
        opts.def.events = _.extend({}, opts.def.events, {
            'click .isc-translate-de2en-btn': 'translate'
        });
    ...
    translate: function () {
        ...
        app.alert.show('isc-tx',{
            level:'info',
            messages: app.lang.get('LBL_ISC_DEEPL_TX_DE2EN'),
            autoClose:false
        });
