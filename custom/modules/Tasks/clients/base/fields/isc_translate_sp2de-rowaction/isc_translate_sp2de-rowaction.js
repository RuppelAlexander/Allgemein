 ...
 * Description   : Spanisch → Deutsch Übersetzung + Kopier-Button
 * ----------------------------------------------------------------------------
 */

//custom/modules/Tasks/clients/base/fields/isc_translate_sp2de-rowaction/isc_translate_sp2de-rowaction.js
({
    extendsFrom: 'ButtonField',
    baseClass  : 'isc-translate-sp2de-btn',

    initialize: function (opts) {
        opts.def.events = _.extend({}, opts.def.events, {
            'click .isc-translate-sp2de-btn': 'translate'
        });
    ...
    translate: function () {
        ...
        app.alert.show('isc-tx',{
            level:'info',
            messages: app.lang.get('LBL_ISC_DEEPL_TX_ES2DE'),
            autoClose:false
        });
